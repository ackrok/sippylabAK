...
function [Hit,JoyStickAtFrames,FramesTS] =Get_2P_Frames_At_BonsaiEventsPretrainingSwitching(Block)
...
block_0_rep= repmat(block_0', 1, length(FramesTS_0));
diff_matrix = abs(block_0_rep - FramesTS_0');
...
if FramesTS>0
    ...
    joystick(:,2)=movmean((joystick1(:,3)),200);
